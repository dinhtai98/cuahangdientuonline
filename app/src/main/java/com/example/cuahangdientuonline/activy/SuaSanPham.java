...
public class SuaSanPham extends AppCompatActivity implements View.OnClickListener {
    ...
    private void EventButton() {
        btnthem.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                String Tensp = edttsp.getText().toString().trim();
                String Giasp = giasp.getText().toString().trim();
                String Motasp = motasp.getText().toString().trim();
                String Loaisp = spinnertsp.getSelectedItem().toString();
