...
public class ThongTinActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng congty = new LatLng(10.768251, 106.659704);
        mMap.addMarker(new MarkerOptions().position(congty).title("Cữa hàng bán đồ điện tử").snippet("284/53 Lý Thường Kiệt, phường 14, quận 10, thành phố Hồ Chí Minh").icon(BitmapDescriptorFactory.defaultMarker()));
        mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
        CameraPosition cameraPosition = new CameraPosition.Builder().target(congty).zoom(90).build();
