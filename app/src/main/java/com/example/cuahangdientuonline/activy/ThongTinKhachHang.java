...
public class ThongTinKhachHang extends AppCompatActivity {
    EditText edittenkhachhang,editsdt,editemail;
                                ...
                                StringRequest request = new StringRequest(Request.Method.POST, Server.duongdanchitietdonhang, new Response.Listener<String>() {
                                    ...
                                    public void onResponse(String response) {
                                        if(response.equals("1")){
                                            ...
                                            CheckConnection.ShowToast_Short(getApplicationContext(),"Đơn hàng của bạn  bị lỗi");
                                        }
    ...
    private void Anhxa() {
        ...
        editemail = findViewById(R.id.edittextemailkhachhang);
        editsdt = findViewById(R.id.edittextsdtkhachhang);
